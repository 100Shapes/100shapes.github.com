...
var $about, $about_btn, $contact, $intro_btn, $nav, $nav_about, $nav_contact, $nav_links, $nav_logo, $nav_logo_pink, $nav_work, $sections, $window, $work, light, nav_flip, pink, scroll_duration,
  _this = this;
...
$(document).ready(function() {
  ...
  return $nav_logo.addClass('white');
});
...
$window.scroll(function() {
  if (pageYOffset > nav_flip) {
    ...
    return $nav_logo.removeClass('white');
  } else {
    $nav.css({
